...
#     mode='pretrain'
# )
config.train_datadir = "/home/hang-disk/桌面/WSDMCUP_BaiduPLM_Paddle/data/train_data"
train_dataset = TrainDataset(config.train_datadir, max_seq_len=128, buffer_size=100000)
